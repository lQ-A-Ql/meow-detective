...
| `crates/persistence-sqlite/` | SQLite repos (22) and migration scripts (47) |
...
| `crates/ceph-wire/`, `rocksdb-wire/` | Read-only Ceph BlueFS, RocksDB MANIFEST replay, active-WAL/WriteBatch decoding, and live-SST structure inspection |
