...
A Tauri 2 desktop application for disk image forensic analysis on Windows. 37 Rust crates, 17 frontend pages, 96 Tauri commands, 2,061 Rust tests. MIT licensed.
...
cd frontend && pnpm test            # Frontend (75 test files)
