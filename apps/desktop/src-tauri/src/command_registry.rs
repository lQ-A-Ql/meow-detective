...
pub(crate) use crate::commands::{
    analysis_commands::{
        ...
        get_kubernetes_cluster_summary, get_linux_artifact_summary, get_plugin_family_entries,
        get_registry_extraction_summary, get_registry_structured_summary, get_system_info,
        get_v2_governance_snapshot, get_v3_governance_snapshot, list_plugin_modules,
