...
$fileCommands = Read-RepoFile "apps/desktop/src-tauri/src/commands/file_commands.rs"
...
Require-Contains "file_commands.rs" $fileCommands "MediaPreviewModeDto::Protocol"
Require-Contains "file_commands.rs" $fileCommands "media_protocol::media_protocol_url"
Require-Contains "file_commands.rs" $fileCommands "pub async fn read_media_range"
Require-Contains "viewer.rs" $viewerDto "pub const MAX_VIEWER_RANGE_LENGTH: u32 = 1024 * 1024;"
Require-Contains "files.ts" $frontendFilesApi "'get_media_url'"
Require-Contains "files.ts" $frontendFilesApi "'read_media_range'"
