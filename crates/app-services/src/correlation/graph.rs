...
use super::coverage::{
    build_family_coverage, derive_rule_group_families, derive_source_group_families,
};
use super::rules::{
...
use super::{
    confidence_rank, dedup_vec, edge_kind_token, insert_node, parse_rfc3339_utc, path_suffix_key,
    CorrelationError, CorrelationRuleGroup, CorrelationRuleMatch, CorrelationSourceGroup,
...
use transport::dto::{
    ...
    CorrelationNodeKindDto, CorrelationProvenanceDto, CorrelationSnapshotDto, TimelineEventDto,
