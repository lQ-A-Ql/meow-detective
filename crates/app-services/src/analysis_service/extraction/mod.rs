...
use self::linux::{linux_candidate_read_limit, linux_candidate_support, LinuxCandidateSupport};
...
struct LinuxSummaryObservability {
    candidate_count: u64,
    coverage_ratio: f32,
    truncated: bool,
    warnings: Vec<String>,
...
fn linux_summary_observability(
    conn: &Connection,
    total_count: u64,
...
fn linux_summary_status(total_count: u64, candidate_count: u64) -> AnalysisParseStatusDto {
    if total_count > 0 {
        AnalysisParseStatusDto::Parsed
