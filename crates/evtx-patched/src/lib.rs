...
pub type EncodingRef = &'static encoding_rs::Encoding;
...
// Upstream sample-based tests are disabled in this vendored library fork because
// the crates.io package does not include the referenced sample EVTX files.
#[cfg(all(test, any()))]
use std::sync::Once;
