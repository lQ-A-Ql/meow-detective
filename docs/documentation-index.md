...
| 事实 | 当前值 | 事实源 |
|---|---:|---|
| Rust workspace crate | 35 | `crates/`（Tauri shell 为独立 workspace package） |
...
| SQLite repositories | 18 | `crates/persistence-sqlite/src/repositories/*_repo.rs` (含 graph_repo、notebook_repo、batch_repo、datasource_cluster_repo、ceph_osd_repo、ceph_bluefs_repo) |
| SQLite migration scripts | 43 | `crates/persistence-sqlite/src/migrations/scripts/*.sql` (0001-0036 + source_001-source_006 + staging_001) |
...
| `crates/persistence-sqlite/src/migrations/scripts/*.sql` | 43 | SQLite migration 脚本 (0001-0036 + source_001-source_006 + staging_001) |
