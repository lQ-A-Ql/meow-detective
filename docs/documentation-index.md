...
| SQLite repositories | 39 | `crates/persistence-sqlite/src/repositories/*_repo.rs` 与 `*_repo/` (含 datasource_cluster_repo、ceph_osd_repo、ceph_osd_device_binding_repo、ceph_bluefs_repo、ceph_bluefs_replay_repo、ceph_rocksdb_repo、ceph_rocksdb_sst_repo、ceph_rocksdb_wal_repo、ceph_rocksdb_latest_state_repo、ceph_bluestore_omap_repo、ceph_bluestore_semantic_repo、ceph_fs_metadata_inventory_repo、ceph_fs_journal_repo、ceph_fs_lineage_repo、ceph_fs_namespace_repo、ceph_fs_namespace_assembly_repo、ceph_fs_capability_repo、ceph_rbd_lineage_repo、processing_phase_repo、analysis_scan_repo、catalog_file_repo、catalog_publication_repo、filesystem_locator_repo、source_meta_repo) |
| SQLite migration scripts | 63 | `crates/persistence-sqlite/src/migrations/scripts/*.sql` (0001-0041 + source_001-source_021 + staging_001) |
...
| `crates/persistence-sqlite/src/migrations/scripts/*.sql` | 63 | SQLite migration 脚本 (0001-0041 + source_001-source_021 + staging_001) |
