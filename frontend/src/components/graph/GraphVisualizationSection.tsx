...
import { SectionHeader } from '@/app/pages/V3ScoreCards';
    ...
    <section>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="flex items-center gap-2 text-[11px]">
            ...
            <select
              ...
              className="rounded border border-[#ddd] bg-white px-1.5 py-1 text-[11px] outline-none"
            >
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="rounded px-1.5 py-0.5 text-[10px] hover:bg-forensics-200"
        >
        ...
        {ALL_EDGE_TYPES.map((type) => (
          ...
          >
            <input
              ...
              className="h-3 w-3 accent-forensics-800"
            />
            <span
