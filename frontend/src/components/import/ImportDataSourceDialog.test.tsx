...
describe('ImportDataSourceDialog', () => {
  ...
  it('calls native file picker when file button is clicked', () => {
    ...
    expect(mocks.tauriOpen).toHaveBeenCalledWith(expect.objectContaining({ directory: false }));
  });
  ...
  it('calls native directory picker when directory button is clicked', () => {
    ...
    expect(mocks.tauriOpen).toHaveBeenCalledWith(expect.objectContaining({ directory: true }));
  });
});
