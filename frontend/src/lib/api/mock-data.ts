  ...
  supportMatrixEntries: [
    {
      ...
      baseline: '椤圭洰鍐?fixture',
      guaranteeSummary: 'open/read/seek 鏍稿績琛屼负涓?bestEffort',
      notes: ['澶氭澶嶆潅鏍锋湰寰呰ˉ銆?'],
    },
    {
      chain: 'RAW',
      ...
      baseline: '椤圭洰鍐?fixture',
      guaranteeSummary: 'open/read/seek 涓?guaranteed',
      notes: ['鍩虹閾捐矾绋冲畾銆?'],
    },
    {
      chain: 'NTFS',
      ...
      baseline: 'fixture 鏂█ / expected.json',
      guaranteeSummary: '鏋氫妇/璇诲彇绋冲畾锛屽鏉?deleted 鎭㈠涓?bestEffort',
      notes: ['澶嶆潅鎹熷潖鏍锋湰涓嶈冻銆?'],
    },
    {
      chain: 'FAT',
      ...
      verifiedSamples: [],
      baseline: '鐜版湁娴嬭瘯',
      guaranteeSummary: '鍩烘湰鏋氫妇涓?experimental',
      notes: ['deleted recovery 涓嶆壙璇恒€?'],
    },
    {
      chain: 'exFAT',
      maturity: 'experimental',
    ...
    },
    {
      ...
      guaranteeSummary: '鍩虹浜嬩欢鎶藉彇涓?bestEffort',
      notes: ['澶ф牱鏈緟琛ャ€?'],
    },
    {
      chain: 'Prefetch',
      ...
      baseline: 'expected.json / 浜哄伐瀵圭収',
      guaranteeSummary: '鏍稿績瀛楁涓?bestEffort',
      notes: ['鍘嗗彶鐗堟湰瑕嗙洊涓嶈冻銆?'],
    },
    {
      chain: 'LNK',
      ...
      baseline: 'expected.json / 浜哄伐瀵圭収',
      guaranteeSummary: 'target path / timestamps 涓?bestEffort',
      notes: ['澶嶆潅 shell item 寰呰ˉ銆?'],
    },
    {
      chain: 'Registry',
      maturity: 'beta',
      ...
      guaranteeSummary: '绯荤粺淇℃伅/鍏抽敭閿€间负 bestEffort',
      notes: ['transaction log 瀹屾暣閲嶆斁鏈壙璇恒€?'],
    },
    {
      chain: 'RecycleBin',
      maturity: 'beta',
      ...
      guaranteeSummary: '鍘熻矾寰?鍒犻櫎鏃堕棿涓?bestEffort',
      notes: ['鎹熷潖鎭㈠涓嶆壙璇恒€?'],
    },
    {
      chain: 'ChromeHistory',
      ...
      verifiedSamples: [],
      baseline: '寮€鍙戞牱鏈?',
      guaranteeSummary: 'visits/downloads 鍩烘湰瀛楁涓?experimental',
      notes: ['鍏紑 medium fixture 寰呰ˉ銆?'],
    },
    {
      chain: 'EdgeHistory',
      maturity: 'experimental',
    ...
    },
    {
      ...
      verifiedSamples: [],
      baseline: '寮€鍙戞牱鏈?',
      guaranteeSummary: 'visit 鍩烘湰瀛楁涓?experimental',
      notes: ['鍏紑 medium fixture 寰呰ˉ銆?'],
    },
    {
      chain: 'Email',
      ...
      verifiedSamples: [],
      baseline: '寮€鍙戞牱鏈?',
      guaranteeSummary: 'sender/recipients/subject 涓?experimental',
      notes: ['PST/OST/mbox 涓嶆壙璇恒€?'],
    },
  ],
