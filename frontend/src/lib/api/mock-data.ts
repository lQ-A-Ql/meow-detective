...
export const recentObjects: RecentObject[] = [
  {
    id: 'obj-1',
    title: 'tasksche.exe',
    detail: '[MOCK] 匹配 YARA 规则: WannaCry_Payload（演示样本）',
...
export const evidenceClassificationSummary: EvidenceClassificationSummary = {
  ...
  categories: [
    ...
    },
    {
      ...
      artifactCount: 5,
      confidence: 0.9,
      warnings: ['Chrome/Edge History 与 Firefox places.sqlite 均按只读副本解析。'],
      sources: [
        {
    ...
    },
    {
      ...
      artifactCount: 3,
      confidence: 0.84,
      warnings: ['v1 mock 覆盖 EML/EMLX；PST/OST/mbox 留待后端扩展。'],
      sources: [
        {
          fileId: 'file-mail-1',
...
export const analysisExtractionRun: AnalysisExtractionRun = {
  ...
  warnings: ['MOCK DATA: 结构化提取结果用于前端集成预览。'],
};
...
export const browserHistorySummary: BrowserHistorySummary = {
  ...
  warnings: ['Chrome/Edge History 与 Firefox places.sqlite 来自 mock 只读副本。'],
  visits: [
    {
...
export const emailExtractionSummary: EmailExtractionSummary = {
  ...
  warnings: ['v1 仅展示 EML/EMLX 结构化字段。'],
  messages: [
    {
      artifactId: 'mail-1',
      fileId: 'file-mail-1',
...
export const timelineEvents: TimelineEventDto[] = [
  {
    ...
    description: 'MOCK TIMELINE: 检测到成功登录事件。',
  ...
  },
  {
    ...
    description: 'MOCK TIMELINE: 在卷根目录检测到文件创建。疑似有效载荷投放。',
  ...
  },
  {
    ...
    description: 'MOCK TIMELINE: 检测到新服务安装。',
...
export const artifactRows: ArtifactRow[] = [
  {
    ...
    summary: '[MOCK] 目标路径: C:/Windows/System32/cmd.exe',
  ...
  },
  {
    ...
    summary: '[MOCK] 目标路径: C:/Temp/payload.exe',
