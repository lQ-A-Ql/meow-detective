  ...
  return (
    <section>
      <div className="flex items-center gap-2 mb-3">
        <span className="text-[13px] font-light text-forensics-text-secondary">{t('settings.sections.importPerformance.title')}</span>
      </div>
      <div className="grid gap-3 md:grid-cols-2">
        <label className="block border border-forensics-border bg-forensics-input-bg p-3">
          <span className="block text-[11px] font-light text-forensics-text-tertiary">{t('settings.sections.importPerformance.maxImportWorkers')}</span>
          <Input
        ...
        <label className="block border border-forensics-border bg-forensics-input-bg p-3">
          <span className="block text-[11px] font-light text-forensics-text-tertiary">{t('settings.sections.importPerformance.maxAnalysisWorkers')}</span>
          <Input
      ...
      <label className="mt-3 block border border-forensics-border bg-forensics-input-bg p-3">
        <span className="block text-[11px] font-light text-forensics-text-tertiary">{t('settings.sections.importPerformance.importAnalysisMode')}</span>
        <Select
