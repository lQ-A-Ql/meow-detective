...
export function MemberEvidenceTable({ members, selectedIndex, onSelect, t }: { members: LinuxEvidenceSetMemberSummary[]; selectedIndex?: number; onSelect: (index: number) => void; t: TFunction }) {
  return (
