...
const summary = (overrides: Partial<LinuxEvidenceSetSummary> = {}): LinuxEvidenceSetSummary => ({
  ...
  scopes: [{ id: 'scope:os', kind: 'os', name: 'node-a', identityState: 'candidate', status: 'partial', evidenceCompleteness: 'partial', memberCount: 1, memberSourceIds: ['a'], diagnostics: [] }],
  edges: [],
  derivedSources: [],
  diagnostics: [],
  ...overrides,
